...
class ViTEmbedder(nn.Module):
    ...
    def __init__(self, patch_size, embed_dim, in_channels):
        ...
        self.block = nn.Sequential(
            ...
            DoubleConv(in_channels=in_channels*2, out_channels=embed_dim, no_adn=True, kernel_size=3),
            nn.PReLU(),
        )
...
class ViTDeEmbedder(nn.Module):
    ...
    def __init__(self, patch_size, embed_dim, out_channels):
        ...
        self.block = nn.Sequential(
            DoubleConv(in_channels=embed_dim, out_channels=out_channels*2, kernel_size=3, no_adn=True),
